...
import net.Poluteclient.phosphor.api.event.events.SlotCheckEvent;
import net.Poluteclient.phosphor.api.util.KeyUtils;
import net.Poluteclient.phosphor.common.Phosphor;
import net.Poluteclient.phosphor.module.modules.combat.ChestStealerModule;
import net.Poluteclient.phosphor.module.modules.combat.InventoryTotemModule;
import net.Poluteclient.phosphor.module.modules.combat.PotRefillModule;
